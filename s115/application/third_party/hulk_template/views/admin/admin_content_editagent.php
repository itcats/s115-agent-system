...
a:2:{s:29:"admin/admin_content_editagent";i:1454318315;s:21:"admin/admin_base_view";i:1454310044;}
*/ ?>
<?php
/**
 * @Author: itcats
...
<div class="content-wrapper">
    ...
    <section class="content">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo site_url('admin/geteditagent') ?>" method="POST">
              <div class="box-body">

                <div class="form-group">
                  <label class="col-sm-2 control-label">代理商名称</label>
                  <div class="col-sm-4">
                    <input name="agentname" type="text" class="form-control" placeholder="代理商名称" value="<?php echo $agent[0]['agentname'] ?>">
                    <?php echo form_error('agentname')?>
                  </div>
                  <label class="col-sm-2 control-label">代理商地址</label>
                  <div class="col-sm-4">
                    <input name="address" type="text" class="form-control" placeholder="代理商联系地址" value="<?php echo $agent[0]['address'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="manager" type="text" class="form-control" placeholder="代理负责人姓名" value="<?php echo $agent[0]['manager'] ?>">
                    <?php echo form_error('manager')?>
                  </div>
                  <label class="col-sm-2 control-label">负责人身份证</label>
                  <div class="col-sm-4">
                    <input name="identity" type="text" class="form-control" placeholder="负责人身份证" value="<?php echo $agent[0]['identity'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="discount" type="text" class="form-control" placeholder="代理商折扣，精确到小数点后2位" value="<?php echo $agent[0]['discount'] ?>">
                    <?php echo form_error('discount')?>
                  </div>
                  <label class="col-sm-2 control-label">代理商性质</label>
                  <div class="col-sm-4">
                   <select class="form-control select2" name="nature" value="<?php echo $agent[0]['nature'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="jointime" type="text" class="form-control" id="reservation" placeholder="加盟时间" value="<?php echo $agent[0]['jointime'] ?>">
                  </div>
                  <label class="col-sm-2 control-label">营业执照</label>
                  <div class="col-sm-4">
                    <input name="license" type="text" class="form-control" placeholder="营业执照，个人可不填" value="<?php echo $agent[0]['license'] ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="phone" type="text" class="form-control" placeholder="手机" value="<?php echo $agent[0]['phone'] ?>">
                    <?php echo form_error('phone')?>
                  </div>
                  <label class="col-sm-2 control-label">QQ</label>
                  <div class="col-sm-4">
                    <input name="qq" type="text" class="form-control" placeholder="QQ" value="<?php echo $agent[0]['qq'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="wechat" type="text" class="form-control" placeholder="微信" value="<?php echo $agent[0]['wechat'] ?>">
                    <?php echo form_error('wechat')?>
                  </div>
                  <label class="col-sm-2 control-label">邮箱</label>
                  <div class="col-sm-4">
                    <input name="email" type="text" class="form-control" placeholder="邮箱" value="<?php echo $agent[0]['email'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="alipayname" type="text" class="form-control" placeholder="支付宝账户名" value="<?php echo $agent[0]['alipayname'] ?>">
                    <?php echo form_error('alipayname')?>
                  </div>
                  <label class="col-sm-2 control-label">支付宝账号</label>
                  <div class="col-sm-4">
                    <input name="alipay" type="text" class="form-control" placeholder="支付宝账号" value="<?php echo $agent[0]['alipay'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="bank" type="text" class="form-control" placeholder="开户银行，精确到支行" value="<?php echo $agent[0]['bank'] ?>">
                  </div>
                  <label class="col-sm-2 control-label">开户名</label>
                  <div class="col-sm-4">
                    <input name="cardholder" type="text" class="form-control" placeholder="开户名" value="<?php echo $agent[0]['cardholder'] ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input name="bankcard" type="text" class="form-control" placeholder="银行卡号" value="<?php echo $agent[0]['bankcard'] ?>">
                  </div>
                </div>
              ...
              <input name="aid" type="hidden" value="<?php echo $agent[0]['aid'] ?>"/>
